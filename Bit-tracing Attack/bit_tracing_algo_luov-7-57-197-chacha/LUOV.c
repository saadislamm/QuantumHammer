...
void _generateKeyPair(unsigned char *pk, unsigned char *sk, bitcontainer *T, bitcontainer *Q1, bitcontainer *Q2) {
	...
	///////////////////////////////////////////////////////////////////////////
	printf("Linear Map T belongs to F2 vxm %dx%d\n", VINEGAR_VARS, OIL_VARS); 
	for (int pp = 1; pp < 5; pp++) {
		printf("%016lx\n", T[pp]);
	}
	printf(".\n.\n.\n");
	for (int pp = VINEGAR_VARS+1-4; pp < VINEGAR_VARS+1; pp++) {
		printf("%016lx\n", T[pp]);
	}
	printf("\n");
	///////////////////////////////////////////////////////////////////////////
...
*/
void luov__sign(unsigned char *sm, unsigned long long *smlen, const unsigned char *m , uint64_t mlen, const unsigned char *sk, const int fast) {
	...
	///////////////////INDUCE SINGLE BIT FLIPS IN T HERE///////////////////////
	T[4] = T[4] ^ 0x0000000000000008;
	///////////////////////////////////////////////////////////////////////////
	...
	/*
	printf("Compressed Solution\n");
	for (int pp = 0; pp < 223; pp++) {
		printf("%02x", sm[pp]);
	}
	printf("\n\n");
	*/
...
int luov_verify_fast(const unsigned char *big_pk , const unsigned char *sm, const unsigned long long smlen , unsigned char* document, unsigned long long *doclen){
	...
	*doclen = smlen - CRYPTO_BYTES;
	...
	/*
	printf("Decompressed Solution\n");
	for (int pp = 1; pp < 255; pp++) {
		printf("%02x", signature[pp]);
	}
	printf("\n\n");
	*/

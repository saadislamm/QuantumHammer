...
void luov__sign(unsigned char *sm, unsigned long long *smlen , const unsigned char* m, uint64_t mlen, const unsigned char *sk, int fast, uint64_t *T, int h, uint8_t *evictionBuffer, int *conflict);
...
#define luov_sign(sm,smlen,m,mlen,sk,T,h,evictionBuffer,conflict) luov__sign(sm,smlen,m,mlen,sk,0, T, h, evictionBuffer, conflict)
